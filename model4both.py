...
class Node2vec(nn.Module):
    ...
    def __init__(
        ...
        self.embedding = nn.Embedding(self.N, embedding_dim, padding_idx=0, sparse=use_sparse)
    ...
    def sample(self, batch):
        ...
        neg_traces = torch.randint(
            1, self.N, (neg_batch.size(0), self.walk_length)
        )
